  ...
  return (
    <div>
      <div className="py-3 my-4">
        ...
        <div
          className="container-fluid taiwan-desktop111 m-0 px-0 py-3 pt-3 mt-3"
          style={{}}
        >
          <div className=" d-md-flex p-0 m-0" style={{}}>
            {!(!isMobile && isTablet) && (
              <div
                className="p-0 m-0"
                style={{ minWidth: isxl ? "20%" : "30%", zIndex: 1 }}
                align="center"
              >
                <div
                  className="mx-auto"
                ...
                >
                  <img
                    ...
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      /*height: 140,*/ width: isMobile ? 300 : "70%",
                      borderRadius: 46,
                  ...
                  <img
                    ...
                    style={{
                      ...
                      right: 16,
                      bottom: "16%",
                      /*height: 170,*/ width: isMobile ? 300 : "90%",
                      borderRadius: 36,
                      border: `1px solid #483d8b99`,
                    }}
                  />
            ...
            >
              ...
              <div></div>
              <h3 className="" style={{ marginRight: 15, textAlign: "right" }}>
                Taiwan Centralized{" "}
              </h3>
              <div
                className=" m-title p-0"
                style={{
                  marginLeft: isMobile ? 0 : isTablet ? 22 : -22,
                  position: "absolute",
                  display: "block",
                  width: "100%",
                  zIndex: -1,
              ...
              <p className="ps-2">
                ...
                for saving opportunity and validating measurable saving results
                by using data visualizations and data driven approaches. It
                consists of MyApps and User Management system in which MyApps
              ...
              <p>
                ...
                information and control access limit for each user.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-fluid taiwan-mobile p-0 m-0" style={{}}>
          <div
            className="pt-4 px-2 mx-0 p-0 centralized"
            style={{ color: "#084C95" }}
          >
            <h3 className="taiwan">Taiwan Centralized</h3>
            <div
              className=" m-title p-0 m-0"
        ...
        <div className="crm-desktop111">
          <div
            className="d-flex crm-desktop111 flex-wrap flex-md-nowrap flex-lg-nowrap flex-xl-nowrap pt-4 mt-3  "
            style={{ color: "#084C95" }}
          >
            <div
              className="m-0 p-0 m-container "
            ...
            >
              ...
              <p style={{ display: "inline-block" }}>
                ...
                able to view and manage orders easily. Users can analyse revenue
                and gross margin by month, products and customers. The system
                will create daily and monthly catalogues and send mails to
                relevant customers, sales team and client manager. Moreover,
                users are able to view reports by product, vendor, month and the
                system is able to send mails to relevant clients, managers and
                sale reps.
              </p>
            </div>
            <div
            ...
            >
              ...
              >
                <img
                  ...
                  alt="view"
                  style={{
                    width: isxlMax ? 200 : 255,
                    height: isxlMax ? 200 : 255,
                    borderRadius: "50%",
                    marginLeft: 10,
                    border: `1px solid #483d8b99`,
                    marginBottom: "10%",
        ...
        <div className="crm-mobile1 p-0 m-0" style={{}}>
          <div
            className="px-2 mx-0 p-0 centralized"
            style={{ color: "#084C95" }}
          >
            ...
            ></div>
            <div
              className="image-box image-container mb-1 d-flex justify-content-center align-items-center"
              style={{
                maxHeight: 600,
                display: "block",
            ...
            >
              <div
                ...
                style={{
                  ...
                  position: "relative",
                  display: "block",
                  right: graterThan ? "20%" : LessThan ? "30%" : 0,
                }}
              >
                <div
                  className="d-flex justify-content-center align-items-center crm-container"
                  style={{}}
                >
                  <img
                    className="img-fluid shadow crm1"
