    ...
    return (
        <div className="d-flex flex-wrap justify-content-center py-3 my-4 mt-5" style={{ height: "100vh" }}> 
            <ParaFragment
                ...
                imgheight={'200px'}
            />
            <div className='col-11' style={{paddingLeft: 16,color: Color.ParagraphColor,wordSpacing: 4 }}>
            ...
            <div className=" col-11 ms-3 me-2" style={{ color: colors.ParagraphColor, fontSize: '14px', wordSpacing: 4 , marginTop: '6%'}}>
