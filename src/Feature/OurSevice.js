...
const OurService = () => {
    ...
    return (
        <div >
            ...
            <div className="row d-flex justify-content-around" style={{color: "#084C95",fontSize: 15,}}>
               
                <div className="col-lg-3 col-md-4 pb-2 mb-2 shadow our-service d-flex flex-sm-wrap" onClick={handleClickDtrAnz} style={{ width: 170, height: 130, border:"1px solid #4B74AD" , borderRadius: 30 , paddingTop: 10,background:"#FFFFFF"}}>
