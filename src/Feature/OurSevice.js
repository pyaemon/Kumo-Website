...
const OurService = () => {
    ...
    const isMobile = useMediaQuery({ query: '(max-width: 767x)' })
            ...
            <div className="col-lg-12 mt-2 pt-4 px-0 mx-0" >
                <div className="row justify-content-center p-0 m-0" style={{ color: "#084C95", fontSize: 14, }}>
                    ...
                    <div className="col-4 col-sm-4 col-md-4 col-lg-2 col-xl-2 col-xxl-1 p-0 m-0">
                        <div className="p-2">
                            <div className="shadow m-0 h-100" onClick={handleClickDtrAnz} style={{  border: "1px solid #4B74AD", borderRadius: 30, paddingTop: 15, background: "#FFFFFF" }}>
                                ...
                                <div className="d-flex flex-column align-items-center" style={{ paddingTop: 8, paddingBottom: 8, }}>
                    ...
                    <div className="col-4 col-sm-4 col-md-4 col-lg-2 col-xl-2 col-xxl-1 p-0 m-0">
                        <div className="p-2">
                            <div className="shadow m-0 h-100" onClick={handleClickDtrAnz} style={{  border: "1px solid #4B74AD", borderRadius: 30, paddingTop: 15, background: "#FFFFFF" }}>
                                <img src={"/icons/globe.png"} alt="view" style={{ display: "block", margin: "auto",height: "60px" }} />
                                <div className="d-flex flex-column align-items-center" style={{ paddingTop: 8, paddingBottom: 8 }}>
                    ...
                    <div className="col-4 col-sm-4 col-md-4 col-lg-2 col-xl-2 col-xxl-1 p-0 m-0">
                        <div className="p-2">
                            <div className="shadow m-0 h-100" onClick={handleClickDtrAnz} style={{  border: "1px solid #4B74AD", borderRadius: 30, paddingTop: 15, background: "#FFFFFF" }}>
                                <img src={"/icons/iphone.png"} alt="view" style={{ display: "block", margin: "auto",height: "60px" }} />
                                <div className="d-flex flex-column align-items-center" style={{ paddingTop: 8, paddingBottom: 8 }}>
                    ...
                    <div className="col-4 col-sm-4 col-md-4 col-lg-2 col-xl-2 col-xxl-1 p-0 m-0">
                        <div className="p-2">
                            <div className="shadow m-0 h-100" onClick={handleClickDtrAnz} style={{  border: "1px solid #4B74AD", borderRadius: 30, paddingTop: 15, background: "#FFFFFF" }}>
                                <img src={"/icons/laptop.png"} alt="view" style={{ display: "block", margin: "auto",height: "60px" }} />
                                <div className="d-flex flex-column align-items-center" style={{ paddingTop: 8, paddingBottom: 8 }}>
                    ...
                    <div className="col-4 col-sm-4 col-md-4 col-lg-2 col-xl-2 col-xxl-1 p-0 m-0">
                        <div className="p-2">
                            <div className="shadow m-0 h-100" onClick={handleClickDtrAnz} style={{  border: "1px solid #4B74AD", borderRadius: 30, paddingTop: 15, background: "#FFFFFF" }}>
                                <img src={"/icons/hangar.png"} alt="view" style={{ display: "block", margin: "auto",height: "60px"}} />
                                <div className="d-flex flex-column align-items-center" style={{ paddingTop: 8, paddingBottom: 8 }}>
                                    <div className="service-text" >Data </div>
